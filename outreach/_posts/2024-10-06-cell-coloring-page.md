...
![cell]({{ site.baseurl }}/assets/images/outreach/yeast-cell-unannotated.jpg){:width="75%" style=".center"}

<!-- more -->

You can download a high-resolution PDF file [here]({{ site.baseurl }}/assets/images/outreach/yeast-cell-unannotated.pdf).
...
![cell-annotated]({{ site.baseurl }}/assets/images/outreach/yeast-cell-annotated.png){:width="75%" style=".center"}
